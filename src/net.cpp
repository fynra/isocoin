...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Isocoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"isocointools.com", "dnsseed.isocointools.com"},
    {"isocoinpool.org", "dnsseed.isocoinpool.org"},
...
static const char *strTestNetDNSSeed[][2] = {
    {"isocointools.com", "testnet-seed.isocointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Isocoin is probably already running."), addrBind.ToString().c_str());
        else
